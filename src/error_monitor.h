...
public:
	...
	long long atom_count_total = 0;	// total number of atoms across compared configurations
	...
	inline double energy_mae_mev_per_atom() { return atom_count_total > 0 ? 1000.0 * ene_all.sum.delta / atom_count_total : 0.0; }
	...
	inline double force_mae_mev_per_a() { return frc_all.count > 0 ? 1000.0 * frc_all.sum.delta / (3*frc_all.count + 1.0e-300) : 0.0; }
	...
	inline double stress_mae_ev() { return str_all.count > 0 ? str_all.sum.delta / (6*str_all.count + 1.0e-300) : 0.0; }
